...
const CardList = ({ item }) => {
  return (
    <div className="h-[60px] w-full bg-gray-200 group rounded-lg hover:bg-gray-400 transition-all duration-200 shadow-lg ease-linear cursor-pointer flex border-2 border-gray-700">
